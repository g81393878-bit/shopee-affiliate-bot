...
def db():
    ...
    s = SessionLocal()
    for m in (models.LeadAction, models.FacebookDemandEvent, models.FacebookDetectedLead, models.FacebookGroupMonitor, models.ChatLog, models.UserPreference, models.User, models.CampaignLog, models.BotPurchase, models.BotPurchaseSlip, models.GroupShareTask):
