...
def payment_reply_text() -> str:
    """ข้อความวิธีจ่ายเงินค่าบอท/มัดจำ — ราคาแพ็กเกจ = ยอดที่จ่ายจริง (ไม่มีค่าติดตั้งแยก) มัดจำ 50% ครึ่ง-ครึ่ง (ลูกค้าเห็นเลขกลม เข้าใจง่าย)"""
    pay_lines = []
    if OWNER_PROMPTPAY:
    ...
    return (
        ...
        "💰 แบ่งจ่าย 2 งวด ครึ่ง-ครึ่ง ชัด ๆ จ๊ะ (มัดจำ 50% จ่ายก่อน · ที่เหลือ 50% จ่ายตอนส่งมอบ):\n"
        "🟡 Lean 490       → มัดจำ 245 · ส่งมอบ 245\n"
        "🟢 Starter 990    → มัดจำ 495 · ส่งมอบ 495\n"
        "🔵 Business 1,990 → มัดจำ 995 · ส่งมอบ 995\n"
        "🟣 White-Label 4,990 → มัดจำ 2,495 · ส่งมอบ 2,495\n"
        "🟠 ขายขาด 15,000–25,000 → มัดจำ 7,500–12,500 · ส่งมอบ 7,500–12,500\n\n"
        "💡 ราคาแพ็กเกจ = จ่ายครั้งแรกทั้งหมด ไม่มีค่าติดตั้งแยก\n"
...
PACKAGE_PAYMENTS = (
    {"key": "lean", "label": "🟡 Lean", "name": "🟡 Lean 490",
     "deposit": "245 บาท", "delivery": "245 บาท",
     "total": "490 บาท", "monthly": "490 บาท/เดือน"},
    {"key": "starter", "label": "🟢 Starter", "name": "🟢 Starter 990",
     "deposit": "495 บาท", "delivery": "495 บาท",
     "total": "990 บาท", "monthly": "990 บาท/เดือน"},
    {"key": "business", "label": "🔵 Business", "name": "🔵 Business 1,990",
     "deposit": "995 บาท", "delivery": "995 บาท",
     "total": "1,990 บาท", "monthly": "1,990 บาท/เดือน"},
    {"key": "whitelabel", "label": "🟣 White-Label", "name": "🟣 White-Label 4,990",
     "deposit": "2,495 บาท", "delivery": "2,495 บาท",
