...
BOT_MANUAL_SECTIONS = [
    ...
    (BUILD_TIME_KWS,
     ...
     "• 🟡 Lean 490 — 1-2 วัน (ตั้งค่าไฟล์เดียว + ส่งคู่มือ)\n"
     "• 🟢 Starter 990 — 2-3 วัน (สินค้า + คีย์ AI + เช็กลิงก์)\n"
     "• 🔵 Business 1,990 — 3-7 วัน (+ โพสต์ FB + เรดาร์ + แดชบอร์ด)\n"
     "• 🟣 White-Label 4,990 — 1-2 สัปดาห์ (เปลี่ยนแบรนด์ + ฐานข้อมูลแยก)\n"
     "• 🟠 ขายขาด — 7-14 วัน (ติดตั้ง + ตั้งค่าให้ครบทั้งระบบ)\n\n"
     "ยิ่งแพ็กเกจสูง ฟีเจอร์ยิ่งเยอะ ใช้เวลาเพิ่มตาม — เริ่มเร็วสุด 1-2 วัน (Lean) "
