...
def payment_reply_text() -> str:
    """ข้อความวิธีจ่ายเงินค่าบอท/มัดจำ — คำนวณยอดมัดจำ/ส่งมอบให้เสร็จ + แนบเลขพร้อมเพย์/บัญชีเมื่อตั้ง env (ลูกค้าไม่ต้องคิดเอง)"""
    pay_lines = []
    if OWNER_PROMPTPAY:
    ...
    return (
        ...
        "💰 จำนวนที่ต้องจ่าย ชัด ๆ จ๊ะ (มัดจำ 50% จ่ายก่อน · ที่เหลือจ่ายตอนส่งมอบ):\n"
        "🟡 Lean 490 → มัดจำ 245 + ส่งมอบ 1,745 = รวม 1,990\n"
        "🟢 Starter 990 → มัดจำ 495 + ส่งมอบ 1,995 = รวม 2,490\n"
        "🔵 Business 1,990 → มัดจำ 995 + ส่งมอบ 2,495 = รวม 3,490\n"
        "🟣 White-Label 4,990 → มัดจำ 2,495 + ส่งมอบ 2,495 = รวม 4,990 (ติดตั้งฟรี)\n"
        "🟠 ขายขาด 15,000–25,000 → มัดจำ 7,500–12,500 + ส่งมอบเท่ากัน = รวม 15,000–25,000\n"
        "🔧 ยอดส่งมอบรวมค่าติดตั้ง 1,500 แล้ว (White-Label ติดตั้งฟรี)\n\n"
        + "\n".join(pay_lines)
