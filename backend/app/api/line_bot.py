...
INSTALL_KWS = ("ติดตั้ง", "ต้องมีอะไร", "ต้องเตรียม", "เตรียมอะไร", "ลงแอป", "ลงอะไร", "ตั้งค่าระบบ", "เริ่มใช้", "เริ่มต้นใช้")
...
INSTALL_REPLY_OWNER = (
    "🛠️ ระบบป้าเข็มต้องมี 4 ส่วน:\n"
    "① บัญชี LINE Official Account — หน้าร้านที่ลูกค้าแอด (free)\n"
    "② Supabase — ฐานข้อมูลคลาวด์ เก็บสินค้า/ลูกค้า/คอนเทนต์ (free tier)\n"
    "③ เซิร์ฟเวอร์ Render — ตัวบอทรัน 24 ชม. + webhook LINE (free tier)\n"
    "④ คีย์ AI — Groq/Gemini สมองสำหรับสร้างคอนเทนต์/ตอบคำถาม (free)\n\n"
    "📌 ขั้นตอนติดตั้งครบอยู่ใน docs/setup-guide.md (ใน repo) — หรือพิมพ์ \"ตั้งค่าระบบ\" ถามต่อได้เลย"
)
...
def message_text(event):
    ...
    try:
        ...
        if normalized_text in DELETE_PHRASES:
            ...
            note = ESCALATE_NOTE if notify_owner_stuck(user, user_text) else ""
