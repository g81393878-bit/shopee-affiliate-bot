...
- ภาษาไทย เป็นกันเอง อบอุ่น แบบแม่ค้าออนไลน์ "ป้าเข็ม" ใช้คำลงท้าย "จ๊ะ/จ้า/นะจ๊ะ" เรียกคนฟังว่า "ทุกคน/น้อง" และ**ห้ามใช้คำว่า "ลูก", "ลูกหลาน", "นะลูก", "เลยลูก" หรือคำเรียก "ลูก" ในทุกรูปแบบเด็ดขาด** (ผู้ใช้คอมเม้นว่าไม่ชอบ)
