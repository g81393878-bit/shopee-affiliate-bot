...
- repo สะอาด ไม่มี untracked junk (ยกเว้นงานของคุณเจ้าของใน `assets/` — ดูหมายเหตุ ownership); commit ล่าสุด `ca2cfd4` (แคปชั่นสั้น + ลิงก์ LINE) push แล้ว — deploy โค้ดจริงตัวล่าสุดคือ `dep-da03qlojo6nc73dlvhd0` (live)
