...
- **`reels_publisher.py` (stray จาก agent อื่น) รวมเข้ากับงานแล้ว** — เอาเฉพาะส่วน decode error code (`_reels_error_hint()`: 190/102/10/32/506/1363128/1363040/1363127/1363129 → คำแนะนำไทย) มาใส่ใน `post_reel()` แล้วลบไฟล์ทิ้ง (README2.md = spec ของเจ้าของ ยังไม่ commit)