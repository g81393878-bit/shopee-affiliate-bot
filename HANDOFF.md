...
- ✅ feat(facebook): **ขยาย `facebook_intro.py` เป็นคลังแคปชั่น 12 แบบ หมุนเวียนไม่ซ้ำ** — จาก 3 โพสต์ตายตัว → 12 โพสต์ (เปิดตัว / วิธีเลือกของ / เตือนภัย / ของถูกvsของคุ้ม / อ่านรีวิว 1 ดาว / โปรโมชันจริงหรือหลอก / เรื่องขำ / ของใช้จริง / งบน้อยก็ช้อปได้ / ส่งฟรี / ของขวัญ / PDPA) — dedup เดิมใช้ index ต่อได้เลย (3 ตัวแรกโพสต์แล้วจะถูกข้าม → ตัวที่ 4-12 โพสต์ตามลำดับ) — **รอ deploy**
