...
```mermaid
flowchart TD
    User([ลูกค้า / ผู้เข้าชมเพจ]) <-->|1. ส่งแชท / ดูโพสต์| FBPage[Facebook Page<br>ID: 61578195882983]
...
| :--- | :--- | :--- |
| **1. Facebook Page** *(เพจร้าน)* | ช่องทางหน้าร้านที่ลูกค้าใช้พิมพ์คุย หรือใช้สำหรับให้บอทโพสต์คอนเทนต์ขายของ | **Page ID** (`61578195882983`) |
