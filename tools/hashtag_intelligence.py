...
# หมวดหมู่อ้างอิงและแท็กพื้นฐานสำหรับ Fallback
DEFAULT_CATEGORY_TAGS = {
    "TRENDING_NEWS": {
        "tiktok": ["#เทรนด์วันนี้", "#ข่าวด่วน", "#สรุปข่าว", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ข่าวด่วน", "#ข่าววันนี้", "#ประเด็นร้อน", "#สรุปข่าว"],
        "facebook": ["#เกาะติดกระแส", "#ข่าวด่วน", "#ข่าวเด่น", "#เรื่องนี้ต้องดู"],
    },
    "CELEBRITY_TREND": {
        "tiktok": ["#เรื่องนี้ต้องดู", "#ข่าวบันเทิง", "#ดาราดัง", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ข่าวบันเทิง", "#ดารา", "#ไวรัลวันนี้"],
        "facebook": ["#ข่าวบันเทิง", "#ดารา", "#กระแสมาแรง", "#เรื่องนี้ต้องแชร์"],
    },
    "WORK_PRODUCTIVITY": {
        "tiktok": ["#TikTokUni", "#ทริคคนทำงาน", "#มนุษย์เงินเดือน", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ทริคคนทำงาน", "#มนุษย์เงินเดือน", "#พัฒนาตัวเอง", "#ชีวิตการทำงาน"],
        "facebook": ["#ทริคคนทำงาน", "#มนุษย์เงินเดือน", "#พัฒนาตัวเอง", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "LIFE_HACK_TIP": {
        "tiktok": ["#เรื่องนี้ต้องดู", "#ทริคดีๆ", "#งานบ้านที่รัก", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#สาระน่ารู้", "#ทริคดีๆ", "#งานบ้านที่รัก", "#วิธีแก้ปัญหา"],
        "facebook": ["#ของดีบอกต่อ", "#ทริคดีๆ", "#งานบ้านที่รัก", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "LUCKY_FORTUNE": {
        "tiktok": ["#สายมู", "#ดวงวันนี้", "#เลขมงคล", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ดวงวันนี้", "#สายมู", "#เลขมงคล", "#เสริมดวง"],
        "facebook": ["#สายมู", "#ดวงวันนี้", "#รับทรัพย์", "#ดวงเฮง"],
    },
    "ของใช้ในบ้าน & จัดระเบียบบ้าน": {
        "tiktok": ["#ของดีบอกต่อ", "#ของใช้ในบ้าน", "#จัดระเบียบบ้าน", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ของใช้ในบ้าน", "#ของดีบอกต่อ", "#จัดบ้าน", "#ป้าเข็มป้ายยา"],
        "facebook": ["#ของดีบอกต่อ", "#ของมันต้องมี", "#ของใช้ในบ้าน", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "สัตว์เลี้ยง & ของใช้หมาแมว": {
        "tiktok": ["#ทาสหมา", "#ทาสแมว", "#ของใช้สัตว์เลี้ยง", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ทาสหมา", "#ทาสแมว", "#ของใช้สัตว์เลี้ยง", "#รีวิวสัตว์เลี้ยง"],
        "facebook": ["#ของดีบอกต่อ", "#ทาสหมา", "#ทาสแมว", "#ของใช้สัตว์เลี้ยง", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "สมาร์ตโฮม & เครื่องใช้ไฟฟ้า": {
        "tiktok": ["#สมาร์ตโฮม", "#เครื่องใช้ไฟฟ้า", "#ของดีบอกต่อ", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#สมาร์ตโฮม", "#เครื่องใช้ไฟฟ้า", "#ไอเทมประจำบ้าน"],
        "facebook": ["#ของดีบอกต่อ", "#สมาร์ตโฮม", "#เครื่องใช้ไฟฟ้า", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "ไอที & แกดเจ็ตมือถือ": {
        "tiktok": ["#ไอทีน่ารู้", "#แกดเจ็ต", "#ของดีบอกต่อ", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ไอที", "#แกดเจ็ต", "#มือถือ", "#ของดีบอกต่อ"],
        "facebook": ["#ของดีบอกต่อ", "#ไอที", "#แกดเจ็ตมือถือ", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "เครื่องครัว & ของกินของใช้": {
        "tiktok": ["#ของดีบอกต่อ", "#เครื่องครัว", "#เข้าครัว", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#เครื่องครัว", "#ของใช้ในครัว", "#ของดีบอกต่อ"],
        "facebook": ["#ของดีบอกต่อ", "#เครื่องครัว", "#แม่บ้าน", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "สุขภาพ & ดูแลตัวเอง": {
        "tiktok": ["#ดูแลสุขภาพ", "#สุขภาพดี", "#ของดีบอกต่อ", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#สุขภาพ", "#ดูแลตัวเอง", "#รักสุขภาพ", "#ของดีบอกต่อ"],
        "facebook": ["#ของดีบอกต่อ", "#สุขภาพดี", "#ดูแลตัวเอง", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "ความงาม & ของใช้ส่วนตัว": {
        "tiktok": ["#บิวตี้", "#ความงาม", "#ของดีบอกต่อ", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#บิวตี้", "#ความงาม", "#ของใช้ส่วนตัว", "#ของดีบอกต่อ"],
        "facebook": ["#ของดีบอกต่อ", "#ความงาม", "#ของใช้ส่วนตัว", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
    "ของใช้ติดรถ & เดินทาง/ช่าง": {
        "tiktok": ["#ของใช้ติดรถ", "#คนรักรถ", "#ของดีบอกต่อ", "#ป้าเข็มรีวิว"],
        "youtube": ["#Shorts", "#ของใช้ติดรถ", "#คนรักรถ", "#อุปกรณ์ช่าง", "#ของดีบอกต่อ"],
        "facebook": ["#ของดีบอกต่อ", "#ของใช้ติดรถ", "#เดินทาง", "#ถ้าไม่คุ้มป้าบอกให้"],
    },
}
